<template>
  ...
  <div v-if="$store.getters.token&&cartList.length>0">
    ...
    <div class="footer-fixed">
      <div  class="all-check">
        <van-checkbox :value="isAllchecked" icon-size="18" @click="toggleALLcheck"></van-checkbox>
        全选
      </div>
...
export default {
  ...
  methods: {
    ...
    changeCount (goodsNum, goodsId, goodsSkuId) {
      ...
      // const res = changeCount(goodsId, goodsNum, goodsSkuId)
      // console.log(res)
      // 调用vuex的action，进行数量的更改
