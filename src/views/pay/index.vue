...
export default {
  ...
  computed: {
    ...
    longAddress () {
      return this.selectAddress.region.province + this.selectAddress.region.city + this.selectAddress.region.region + this.selectAddress.detail
    },
    cartIds () {
  ...
  methods: {
    ...
    async getOrderList () {
      if (this.mode === 'cart') {
        ...
        // console.log(res)
        console.log(this.order, this.personal)
      }
      if (this.mode === 'buyNow') {
    ...
    async submitOrder () {
      ...
      if (this.mode === 'buyNow') {
        await submitOrder(this.mode, { goodsId: this.goodsId, goodsSkuId: this.goodsSkuId, goodsNum: this.goodsNum, remark: this.remark })
      }
