...
import { getGoodsDetail } from '@/api/proDetail'
import { getProComments } from '@/api/product'
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      const res = await getCart(this.goodsId, this.addCount, this.detail.skuList[0].goods_sku_id)
      console.log(res)
      const { data } = res
